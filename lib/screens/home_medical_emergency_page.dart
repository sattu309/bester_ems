...
class MedicalEmergencyPage extends StatefulWidget {
  ...
  final String eTypeHome;

  const MedicalEmergencyPage({
    Key? key,
    required this.emsTypeMedical,
    required this.emsTypeInjury,
    required this.emsTypeMotor,
    required this.emsTypeSec,
    required this.eTypeHome,
  }) : super(key: key);
...
class _MedicalEmergencyPageState extends State<MedicalEmergencyPage> {
  ...
  saveDataLocally() async {
    var data = {
      "reqStatus": "1",
      "eType": widget.emsTypeMedical == "medical"
          ? 'medical'
    ...
    log("SAVE LOCAL DATA ${prefs.getString("data")!}");  }
  ...
  void initState() {
    super.initState();
    userDataController.getDataLocally();
    log("TESTING ${userDataController.eType.value.toString()}");
    log(widget.eTypeHome);
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: widget.emsTypeMedical == "medical"
                                ? const AssetImage(
                                    "assets/images/medicalmain.png",
                                  )
                                : widget.emsTypeMotor == "motor"
                                    ? const AssetImage(
                                        "assets/images/motorbg.png",
                                      )
                                    : widget.emsTypeInjury == "injury"
                                        ? const AssetImage(
                                            "assets/images/injurybg.png",
                                          )
                                        : widget.emsTypeSec == "sec"
                                            ? const AssetImage(
                                                "assets/images/secbg.png",
                                              )
                                            : const AssetImage(
                                                "assets/images/secbg.png",
                                              ),
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                getActiveAlertModel!.success != null &&
                                        getActiveAlertModel!.success!.status ==
                                            1
                                    ? Expanded(
                                        child: Text(
                                    ...
                                    Text(
                                        getActiveAlertModel!.success != null &&
                                                getActiveAlertModel!
                                                        .success!.emstype ==
                                                    "sec"
                                            ? userDataController.showSec.value
                                            : userDataController
                                                .userAppName.value,
                                        style: GoogleFonts.poppins(
                                            fontSize: 19,
                            ...
                            addHeight(15),
                           ( widget.emsTypeMedical == userDataController.eType.value ||  widget.emsTypeMotor == userDataController.eType.value ||
                                widget.emsTypeInjury == userDataController.eType.value || widget.emsTypeSec == userDataController.eType.value && userDataController.status.value ==
                                "1")  &&
                                    (getActiveAlertModel!.success != null &&
                                            getActiveAlertModel!
                                                    .success!.status ==
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: ElevatedButton(
                                            onPressed: () {
                                              log(userDataController
                                                  .eType.value);
                                              log(userDataController
                                                  .status.value);
                                              log(widget.eTypeHome.toString());
                                              sendAlertRepo(
                                                      userLat:
                                                          locationController
                                                              .lat.value
                                      ...
                                      Container(
                                        ...
                                        child: ElevatedButton(
                                            onPressed: () {
                                              sendAlertRepo(
                                                userLat: locationController
                                                    .lat.value
                                                    .toString(),
                                                userLong: locationController
                                                    .long.value
                                                    .toString(),
                                                emerType: widget
                                                            .emsTypeMedical ==
                                                    ...
                                                    : widget.emsTypeMotor ==
                                                        ...
                                                        : widget.emsTypeInjury ==
                                                            ...
                                                            ? "injury"
                                                            : "Security Emergency",
                                                userAddress: locationController
                                                    .concatenatedString.value
                                                    .toString(),
                                                alertStatus: '3',
                                                alertID: getActiveAlertModel!
                                                    .success!.id
                                                    .toString(),
                                                context: context,
                                              ).then((value) {
                                ...
                                : Container(
                                    ...
                                    child: ElevatedButton(
                                        onPressed: () async {
                                          log(userDataController.eType.value);
                                          log(userDataController.status.value);
                                          log(widget.eTypeHome);
                                          if (
                                          getActiveAlertModel!.success == null
                                          // userDataController.status.value ==
                                          //         "" &&
                                          //     userDataController.eType.value !=
                                          //         widget.eTypeHome
                                          ) {
                                            sendAlertRepo(
                                                    userLat: locationController
                                              ...
                                              if (value.success != null) {
                                                ...
                                                SharedPreferences pref =
                                                    await SharedPreferences
                                                        .getInstance();
                                                log("LOCAL STATUS RESULT ${userDataController.status.value}");
                                                log("LOCAL DATA STORAGE CLEAR ${pref.getString('data')!}");
                                            ...
                                            Helpers.showToast(
                                                "You have already requested for the ${userDataController.eType.value} Emergency");
                                          }
                                        },
                                        style: ElevatedButton.styleFrom(
                                          minimumSize: Size(AddSize.screenWidth,
                                              AddSize.size50 * 1.2),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    addHeight(10),
                    Text(
                        "Hi ${userDataController.userName.value}, we've received your Medical Emergency. We are here for you!",
                        textAlign: TextAlign.center,
                        style: GoogleFonts.poppins(
                            fontSize: 12,
                            color: Colors.black,
